...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Note: The temporal separation (Evaluation 2017-18 vs. Training 2019-22) ensures a robust test of the model's ability to generalize to future or distinct political contexts.}
    \end{itemize}
\end{itemize}

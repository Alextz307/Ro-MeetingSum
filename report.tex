...
\begin{itemize}
    ...
    \begin{itemize}
        \item For English news summarization (high-resource), SOTA models often reach ROUGE-1 of \textbf{0.40 - 0.45}.
        \item For low-resource languages like Romanian, typical scores are in the \textbf{0.30 - 0.35} range.
    \end{itemize}
    ...
    \item \textbf{Structure vs Content:} The Extractive model scored higher on ROUGE-L (0.25 vs 0.23). This is typical for extractive approaches which preserve original sentence structures perfecty, whereas abstractive models paraphrase, potentially altering word sequences even if the meaning remains correct.
\end{itemize}
